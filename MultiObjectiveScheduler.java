...
import Vivek.HEFTScheduler.CloudletRank;
...
public class MultiObjectiveScheduler extends BaseCloudletScheduler {
...
protected void calculateRanks() {
	...
	public MultiObjectiveScheduler(List<Cloudlet> cloudletlist, List<Vm> vmlist) {
		...
		critical = new HashMap<Cloudlet, Boolean>();
	}
...
/*						while(na.get(pos).failure <= makespan){
	...
	protected void adjustcloudletSlack(){
		List<CloudletRank> cloudletRank = new ArrayList<CloudletRank>();
